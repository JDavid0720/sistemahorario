	...
	<div class="body">
		<div class="section-croppie-image">
			...
			<div class="options">
				...
				<a href="/sistemaHorario/user" class="cancel-btn"><span class="icon">close</span></a>
			</div>
		</div>
			...
			<div class="wrap">
				<div class="first">
					<div class="section-user-image">
						<img src="<?php echo '/sistemaHorario/images/users/' . $_SESSION['user_image']; ?>" />
						<?php
				...
				<div class="last">
					<div class="config-data-user">
						...
						<a class="btn-edit-info-user" href="../modules/administratives"><span class="icon">edit_note</span>Información Personal</a>
