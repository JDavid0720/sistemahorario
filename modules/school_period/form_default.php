...
unset($_SESSION['school_periods_name']);
...
if (isset($_SESSION['school_period']) != '') {
	...
	$_SESSION['school_periods_name'] = array();
	...
	if ($result = $conexion->query($sql)) {
		while ($row = mysqli_fetch_array($result)) {
			...
			$_SESSION['school_periods_name'][$i] = $row['school_period_name'];
	...
	<div class="body">
		<form name="form-add-groups-subjects" action="process.php" method="POST">
			<div class="wrap">
				...
				if ($i == 0) {
					echo '<img src="/sistemaHorario/images/404.svg" class="data-not-found" alt="404">';
				}
				?>
			</div>
