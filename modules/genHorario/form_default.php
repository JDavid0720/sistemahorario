...
for ($hora = 7; $hora <= 22; $hora++) {
    ...
    for ($dia = 1; $dia <= 7; $dia++) {
        ...
        actividad.Id_actividad, actividad.CI, actividad.ACD, actividad.APE,
        actividad.HVIR, actividad.OAD, actividad.HG, actividad.HI, actividad.HVHPP,
 ...
 FROM horario
 LEFT JOIN actividad ON horario.Id_actividad = actividad.Id_actividad
