...
<div class="nav-home">
    ...
    <ul>
        <li><a class="<?php if ($output[1] == 'home') {
                            echo 'active';
                        } ?>" href="/sistemaHorario/home"><span class="icon">dashboard</span>Dashboard</a></li>
        <li><a class="<?php if ($output[1] == 'teachers') {
                            echo 'active';
                        } ?>" href="/sistemaHorario/modules/teachers"><span class="icon">connect_without_contact</span>Docentes</a></li>
        <li><a class="<?php if ($output[1] == 'students') {
                            echo 'active';
                        } ?>" href="/sistemaHorario/modules/students"><span class="icon">recent_actors</span>Alumnos</a></li>
        <li><a class="<?php if ($output[1] == 'careers') {
                            echo 'active';
                        } ?>" href="/sistemaHorario/modules/careers"><span class="icon">school</span>Carreras</a></li>
        <li><a class="<?php if ($output[1] == 'subjects') {
                            echo 'active';
                        } ?>" href="/sistemaHorario/modules/subjects"><span class="icon">library_books</span>Asignaturas</a></li>
            ...
            <ul>
                <li>
                    <a class="<?php if ($output[1] == 'home') {
                                    echo 'active';
                                } ?>" href="/sistemaHorario/home" title="Dashboard"><span class="icon">dashboard</span></a>
                </li>
                <li>
                    <a class="<?php if ($output[1] == 'teachers') {
                                    echo 'active';
                                } ?>" href="/sistemaHorario/modules/teachers" title="Docentes"><span class="icon">connect_without_contact</span></a>
                </li>
                <li>
                    <a class="<?php if ($output[1] == 'students') {
                                    echo 'active';
                                } ?>" href="/sistemaHorario/modules/students" title="Alumnos"><span class="icon">recent_actors</span></a>
                </li>
                <li>
                    <a class="<?php if ($output[1] == 'careers') {
                                    echo 'active';
                                } ?>" href="/sistemaHorario/modules/careers" title="Carreras"><span class="icon">school</span></a>
                </li>
                <li>
                    <a class="<?php if ($output[1] == 'subjects') {
                                    echo 'active';
                                } ?>" href="/sistemaHorario/modules/subjects" title="Asignaturas"><span class="icon">library_books</span></a>
                </li>
                <li>
                    <a class="<?php if ($output[1] == 'groups') {
                                    echo 'active';
                                } ?>" href="/sistemaHorario/modules/groups" title="Grupos"><span class="icon">groups</span></a>
                </li>
            </ul>
        </nav>
    </header>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a href="/sistemaHorario/modules/logout" title="Cerrar Sesión"><span class="icon">logout</span></a>
                </li>
            </ul>
        </nav>
    </header>
